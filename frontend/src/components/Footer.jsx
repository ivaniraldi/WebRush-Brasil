...
const Footer = () => {
  ...
  return (
    <motion.footer 
      className="bg-gray-100 text-gray-800 py-12 mt-auto w-full"
      initial="initial"
      whileInView="animate"
      viewport={{ once: true }}
      variants={fadeIn}
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-green-600" itemProp="name">
              WebRush Brasil
            </h3>
            <p className="text-gray-600" itemProp="description">
              Transformando negócios através de sites incríveis.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-300 text-center">
          <p className="text-gray-600">
            &copy; {currentYear} WebRush Brasil. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </motion.footer>

...
const Contact = () => {
  const { services, contactStatus, sendContactMessage } =
  ...
  const serviceTypes = [
    ...
    },
    {
      ...
      description: "SEO, publicidade e gestão de redes sociais",
    },
  ];
    ...
    web: [
      {
        ...
        name: "Básico",
        price: "R$ 2.500",
        description: "Site institucional básico",
      },
      {
        id: "pro",
        name: "Profissional",
        price: "R$ 5.000",
        description: "Site com recursos avançados",
      },
      {
        id: "premium",
        name: "Premium",
    ...
    marketing: [
      {
        ...
        name: "Básico",
        price: "R$ 499",
        description: "Gestão básica de redes sociais",
      },
      {
        id: "pro",
        name: "Profissional",
        price: "R$ 3.000",
        description: "Gestão completa + publicidade",
      },
      {
        id: "premium",
        name: "Premium",
        price: "Personalizado",
        description: "Estratégia completa personalizada",
      },
    ],
  };
  ...
  const validateForm = () => {
    ...
    if (!formData.serviceType)
      tempErrors.serviceType = "Por favor, selecione o tipo de serviço";
...
${
  formData.additionalIdeas
    ? `Ideias Adicionais: ${formData.additionalIdeas}`
    : ""
}
        `.trim();
  ...
  const nextStep = () => {
    ...
    fieldsToValidate.forEach((field) => {
      if (!formData[field]) {
        stepErrors[field] = `${
          field === "fullName" ? "Nome completo" : field
        } é obrigatório`;
    ...
    if (Object.keys(stepErrors).length === 0) {
      ...
      window.scrollTo({
        top: document.getElementById("form-container").offsetTop - 100,
        behavior: "smooth",
      });
    }
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-20 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-300">
              Estamos aqui para transformar suas ideias em realidade. Nossa
            ...
            {formStep < 4 && (
              <div className="mb-10">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <div
                    className={`h-1 w-16 sm:w-24 ${
                      formStep >= 2 ? "bg-violet-600" : "bg-gray-700"
                    } transition-colors duration-300`}
                  ></div>
                  <div
                    className={`flex items-center justify-center w-10 h-10 rounded-full ${
                  ...
                  <div
                    className={`h-1 w-16 sm:w-24 ${
                      formStep >= 3 ? "bg-violet-600" : "bg-gray-700"
                    } transition-colors duration-300`}
                  ></div>
                  <div
                    className={`flex items-center justify-center w-10 h-10 rounded-full ${
                ...
                <div className="flex justify-between text-sm text-gray-400 px-4">
                  <span
                    className={
                      formStep >= 1 ? "text-neon-green font-medium" : ""
                    }
                  >
                    Seus Dados
                  </span>
                  <span
                    className={
                      formStep >= 2 ? "text-neon-green font-medium" : ""
                    }
                  >
                    Serviço
                  </span>
                  <span
                    className={
                      formStep >= 3 ? "text-neon-green font-medium" : ""
                    }
                  >
                    Detalhes
                  </span>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {servicePlans[formData.serviceType]?.map((plan) => (
                        ...
                        >
                          <h4 className="text-lg font-bold mb-2 text-wrap">
                            {plan.name}
                          </h4>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              ...
              serviços e processo de atendimento.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              {[
                {
                  question:
                    "Qual é o prazo médio para conclusão de um projeto?",
                  answer:
                    "O prazo varia de acordo com a complexidade do projeto. Projetos simples podem ser concluídos em 2-3 semanas, enquanto projetos mais complexos podem levar de 1 a 3 meses. Após nossa análise inicial, forneceremos um cronograma detalhado.",
                },
                {
                  question: "Como funciona o processo de pagamento?",
                  answer:
                    "Trabalhamos com um modelo de pagamento em etapas. Geralmente, 30% no início do projeto, 40% na entrega da primeira versão e 30% na conclusão. Aceitamos transferências bancárias, PIX e cartões de crédito.",
                },
                {
                  question:
                    "Vocês oferecem suporte após a conclusão do projeto?",
                  answer:
                    "Sim, oferecemos 30 dias de suporte gratuito após a entrega final do projeto. Após esse período, temos planos de manutenção mensal que podem ser contratados de acordo com suas necessidades.",
                },
                {
                  question:
                    "É possível fazer alterações durante o desenvolvimento do projeto?",
                  answer:
                    "Sim, entendemos que ajustes são parte do processo criativo. Pequenas alterações estão incluídas no escopo inicial. Mudanças significativas podem requerer ajustes no orçamento e prazo, que serão discutidos previamente.",
                },
              ].map((faq, index) => (
                <motion.div
                  key={index}
